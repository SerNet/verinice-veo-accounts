...
testing {
    suites {
        configureEach {
            dependencies {
                implementation("io.kotest:kotest-assertions-core-jvm:6.2.3")
                implementation("io.kotest:kotest-runner-junit5-jvm:6.2.3")
                implementation("io.kotest:kotest-assertions-core-jvm:6.2.3")
        ...
        register<JvmTestSuite>("restTest") {
            ...
            dependencies {
                ...
                implementation("org.keycloak:keycloak-authz-client:26.0.11")
