...
testing {
    suites {
        configureEach {
            dependencies {
                implementation("io.kotest:kotest-assertions-core-jvm:6.1.5")
                implementation("io.kotest:kotest-runner-junit5-jvm:6.1.5")
                implementation("io.kotest:kotest-assertions-core-jvm:6.1.5")
                implementation("io.kotest:kotest-property-jvm:6.1.5")
            }
        }
